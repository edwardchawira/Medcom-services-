 ...
 */
window.MEDCOM_MEDICATION_COURSE = {
        ...
        <div class="mb-6">
          <div class="p-1 rounded-2xl bg-gradient-to-br from-teal-400 via-cyan-400 to-indigo-400 shadow-sm">
            <div class="bg-white rounded-2xl overflow-hidden">
              <img
                src="https://picsum.photos/seed/homecare-medcom-responsibilities/1200/800"
                alt="Care worker speaking with an older adult at home"
