  ...
  chapters: [
    {
      ...
      html: `
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Key guidance and further reading</h3>
        ...
        <details class="bg-teal-50 border border-teal-100 rounded-lg p-4">
          ...
          <p class="mt-3 text-sm text-slate-700">Why is this module described as theory only, and what must you complete before administering medication?</p>
        </details>`
    },
    {
      id: 2,
      ...
      html: `
        <p class="text-xs text-slate-500 mb-4"><i class="far fa-clock mr-1"></i> About 4 minutes</p>
        <h3 class="text-lg font-semibold text-slate-900 mb-3">At a glance</h3>
        <ul class="space-y-2 mb-6 text-slate-800 text-sm">
        ...
        <div class="mb-6">
          ...
          <p class="text-xs text-slate-500 mt-2">Home care often includes medicine reminders, packaging support, and careful documentation.</p>
        </div>
        <p class="mb-4 text-slate-800">As a <strong>home care assistant</strong>, you play a crucial role in the well-being of those you care for. This course is tailored to help you understand and effectively fulfil your responsibilities in medication support.</p>
        <p class="mb-4 text-slate-700">Most people receiving care in their own homes are prescribed medication at some time as part of their treatment by their doctor or nurse, and many have multiple medication needs. A <strong>medication</strong> is a drug used to diagnose, cure, treat, or prevent disease. A service user may be taking regular prescribed or non-prescribed medication.</p>
        <p class="mb-4 text-slate-700">While many service users manage their medication effectively themselves with appropriate support from informal carers, some ask for or need support with their medicines from their home care provider. Their needs can range from simple reminders and help with packaging through to actual administration of medication.</p>
        <p class="mb-4 text-slate-700">In some cases, this might include the administration of <strong>controlled drugs</strong>, which requires care workers to know how they are being safely stored and administered in the home setting.</p>
        <div class="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-6 text-sm text-slate-800">
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">What do you need to know?</h3>
        <p class="mb-4 text-slate-700">Firstly, it is important to know the difference between <strong>prompting</strong>, <strong>assisting</strong> with, and <strong>administering</strong> medication.</p>
        <ul class="list-disc pl-6 space-y-2 mb-4 text-slate-700 text-sm">
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-6 text-sm text-slate-900">
          <strong>⚠</strong> Medication is only ever administered by a <strong>designated, appropriately trained</strong> member of staff.
        </div>
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Laws and guidance</h3>
        <p class="mb-4 text-slate-700">In the UK, your role in medication support is guided by specific laws and guidelines. It is crucial that we operate within these legal boundaries to ensure the safety and rights of everyone involved. Key legislation and guidance include the <strong>Health and Social Care Act</strong> and guidance from organisations such as the <strong>CQC</strong> and <strong>NICE</strong>.</p>
        <p class="mb-4 text-slate-700">Understanding these guidelines helps protect service users and you as a care provider. It helps ensure care is safe, effective, and respectful of each person’s autonomy and dignity.</p>
        <p class="mb-6 text-sm text-slate-700 border-l-4 border-slate-300 pl-3"><strong>Autonomy</strong>: a person’s independence and freedom to make their own decisions.</p>
        <p class="text-slate-700 mb-6">During this course we explore these aspects in more detail so you can feel confident in your crucial role. Your work makes a significant difference; being well informed is key to doing it successfully.</p>
        <div class="mcq-root border-2 border-slate-200 rounded-xl p-5 bg-slate-50 mt-2">
          <p class="font-semibold text-slate-900 mb-1">Check your answer</p>
          <p class="text-sm text-slate-700 mb-4">What is usually <strong>not</strong> part of a home care assistant’s role in medication support?</p>
          <div class="space-y-2">
            <button type="button" class="mcq-opt w-full text-left px-4 py-3 rounded-lg border border-slate-300 bg-white hover:bg-teal-50 hover:border-teal-300 text-sm text-slate-800 transition-colors" data-correct="true">Administering medication.</button>
            <button type="button" class="mcq-opt w-full text-left px-4 py-3 rounded-lg border border-slate-300 bg-white hover:bg-teal-50 hover:border-teal-300 text-sm text-slate-800 transition-colors" data-correct="false">Reminding clients to take their medication.</button>
            <button type="button" class="mcq-opt w-full text-left px-4 py-3 rounded-lg border border-slate-300 bg-white hover:bg-teal-50 hover:border-teal-300 text-sm text-slate-800 transition-colors" data-correct="false">Helping clients access their medicines.</button>
            <button type="button" class="mcq-opt w-full text-left px-4 py-3 rounded-lg border border-slate-300 bg-white hover:bg-teal-50 hover:border-teal-300 text-sm text-slate-800 transition-colors" data-correct="false">Monitoring side effects of medications.</button>
          </div>
          <p class="mcq-feedback mt-3 text-sm min-h-[1.25rem] text-slate-600" aria-live="polite"
    ...
    },
    {
      ...
      html: `
        ...
        <p class="mb-4 text-slate-700"><strong>Administration</strong> means you actually give the medicine (e.g. placing a tablet in the mouth). Only staff who are trained and authorised may administer.</p>
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Why the distinction matters</h3>
        <p class="text-slate-700 mb-4">Getting it wrong can harm the person, break the law, or invalidate insurance. Always record what level of support you provided.</p>
        <details class="bg-teal-50 border border-teal-100 rounded-lg p-4">
          <summary class="font-semibold text-teal-900 cursor-pointer">Check understanding</summary>
          <p class="mt-3 text-sm text-slate-700">Opening a blister strip and handing the blister to the person to press a tablet out themselves: prompting, assisting, or administering?</p>
        </details>`
    },
    {
      id: 4,
      ...
      html: `
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Person-centred approach</h3>
        <p class="text-slate-700 mb-4">Ask what help they want, offer the <em>least</em> intrusive support that keeps them safe, and review when their condition changes.</p>
    ...
    },
    {
      ...
      html: `
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Communication</h3>
        <p class="text-slate-700 mb-4">Use clear, respectful language; check understanding; involve family or advocates when appropriate and agreed in the care plan.</p>
    ...
    },
    {
      ...
      html: `
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">What to look for</h3>
        <p class="text-slate-700 mb-4">New rashes, swelling, breathing difficulty, sudden confusion, severe drowsiness, vomiting, or any rapid change after a new medicine should be reported urgently per policy.</p>
        <p class="text-sm text-slate-600">Escalation routes (on-call nurse, GP, 999) are defined locally. Never delay if you suspect an emergency.</p>`
    },
    {
      id: 8,
      ...
      html: `
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Escalation</h3>
        <p class="text-slate-700 mb-4">Follow policy: there may be a risk assessment, GP review, or mental capacity process if there is concern they cannot understand the decision.</p>
        <div class="bg-red-50 border border-red-100 rounded-lg p-4 text-sm text-slate-800">Never attempt to administer covertly unless there is a lawful, authorised plan. This is outside a standard prompting/assisting module.</div>`
    },
    {
      id: 9,
    ...
    },
    {
      ...
      html: `
        <p class="mb-4 font-medium text-slate-900">Scenario 1</p>
        <p class="mb-4 text-slate-700">A service user can swallow tablets but cannot peel a foil. You open the foil and they take the tablet from the blister. What kind of support is this?</p>
        <p class="mb-6 font-medium text-slate-900">Scenario 2</p>
        <p class="mb-4 text-slate-700">They say they feel sick after a new antibiotic. What do you do first after ensuring immediate safety?</p>
        <p class="text-sm text-slate-500">Compare answers in supervision; local policy is decisive.</p>`
    },
    {
      id: 13,
      title: "Summary",
      html: `
        <h3 class="text-lg font-semibold text-slate-900 mb-3">Key takeaways</h3>
        ...
        <p class="text-slate-700">You are ready to review and attempt the end-of-module check when your employer enables it.</p>`
    },
    {
      id: 14,
    ...
    },
    {
      ...
      html: `
        ...
        <p class="text-slate-700">When ready, use <strong>Next</strong> to open the Assessment step.</p>`
    }
  ],
  assessmentHtml: `
    ...
    <h3 class="text-lg font-semibold text-slate-900 mb-2">Before you start</h3>
    <ul class="list-disc pl-6 space-y-2 mb-6 text-slate-700 text-sm">
    ...
    <h3 class="text-lg font-semibold text-slate-900 mb-3">Practice question (demo)</h3>
    <p class="text-sm text-slate-700 mb-3">Which action is <em>most</em> appropriate when a capacitous adult refuses a dose?</p>
    <div class="space-y-2 mb-6 text-sm">
      <label class="flex items-start gap-2 p-3 rounded-lg border border-slate-200 cursor-pointer hover:bg-slate-50"><input type="radio" name="demoq" class="mt-1" disabled /><span>Record the refusal and report per policy without pressuring them.</span></label>
      <label class="flex items-start gap-2 p-3 rounded-lg border border-slate-200 cursor-pointer hover:bg-slate-50"><input type="radio" name="demoq" class="mt-1" disabled /><span>Hide the tablet in food so they take it anyway.</span></label>
    </div>
    <div class="bg-slate-100 rounded-lg p-6 text-center">
      <p class="text-slate-600 mb-4">Live question bank and scoring connect here in production.</p>
      <button type="button" disabled class="px-6 py-3 rounded-lg bg-slate-300 text-slate-500 cursor-not-allowed font-semibold">Submit assessment (demo)</button>
    </div>`
};
